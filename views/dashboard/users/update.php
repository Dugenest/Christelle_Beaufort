...
<h1>Modification d'un utilisateur</h1>
    ...
    <form method="post" action="">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="lastname" name="lastname" value="<?=$user->lastname??''?>" maxlength='30' aria-describedby="lastNameHelp" placeholder="Veuillez entrer votre nom svp?">
            <div class="error">
                <?= $error['lastname'] ?? ''?>
                <?= $msg['success'] ?? '' ?>
            </div><br>
