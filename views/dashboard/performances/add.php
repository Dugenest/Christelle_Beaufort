...
<form method="post" action="">
    <div class="row justify-content-center">
        <div class="col col-md-6 mb-3">
            <label for="id_category" class="form-label"><strong>Nom la prestation </strong></label>
            ...
            <textarea type="text" class="form-control" id="description" name="description" value="<?= $description ?? '' ?>" maxlength='300' row="10" aria-describedby="descriptionHelp" placeholder="Veuillez entrer votre description de la prestation svp?" required></textarea>
            <div class="error">
